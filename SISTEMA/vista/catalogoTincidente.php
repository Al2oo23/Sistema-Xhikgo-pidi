                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="aviso_Tincidente_buscado" class="form-control"
                                            placeholder="Tipo de Incidente" name="incidente_Tincidente_buscado"
                                            value="<?= isset($_POST['incidente_Tincidente_buscado']) ? $_POST['incidente_Tincidente_buscado'] : '' ?>">
                                    </div>
                                </div>
                                    ...
                                    <tr class="fila">
                                        ...
                                        <td>
                                            <div class="botones" style="justify-content:space-evenly;">
                                                ...
                                                <div><a href='../controlador/ctl_Tincidente.php?txtID=<?= $filtrado['id']; ?>'
