                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="aviso_Taviso_buscado" class="form-control"
                                            placeholder="Tipo de Aviso" name="aviso_Taviso_buscado"
                                            value="<?= isset($_POST['aviso_Taviso_buscado']) ? $_POST['aviso_Taviso_buscado'] : '' ?>">
                                    </div>
                                </div>
                                <div class="col-12 d-flex justify-content-between">
                                    ...
                                    <div>
                                        ...
                                        <button type="submit" id="limpiar_Taviso" name="limpiar_Taviso"
                                            class="btn btn-danger me-1 mb-1">Limpiar</button>
                                        <button type="submit" id="buscar_Taviso" name="buscar_Taviso"
                                    ...
                                    <tr class="fila">
                                        ...
                                        <td>
                                            <div class="botones" style="justify-content:space-evenly;">
                                                ...
                                                <div><a href='../controlador/ctl_Taviso.php?txtID=<?= $filtrado['id']; ?>'
