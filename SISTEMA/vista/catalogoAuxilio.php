<?php
$nombrePagina = "Catálogo de  Auxilio Medico";
require ('../header.php');
...
<div class="col-12" id="catalogo">
    ...
    <div class="row" id="table-hover-row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Incidente de Auxilio Medico de Emergencia</h4>
                    <?php include ("modal/modalAuxilioR.php"); ?>
                </div>
                <!-- table hover -->
                    ...
                    <table class="table table-hover mb-0" id="tabla_se">
                        <thead>
                            <tr style="text-align: center;">
                                ...
                                <th class="columna">traslado</th>
                                <th class="columna">Nombre Completo</th>
                                <th class="columna">Habitacion</th>
                                <th class="columna">Lesion</th>
                        ...
                        <tbody>
                            <?php // foreach ($servicios as $se): ?>
                                ...
                                <tr class="fila">
                                    <!-- <td class="columna" hidden>["id"];</td>
                                    <td class="columna">["fecha"];</td>
                                    <td class="columna">["seccion"];</td>
                                    <td class="columna" hidden>["estacion"];</td>
                                    <td class="columna" hidden>["aviso"];</td>
                                    <td class="columna" hidden>["solicitante"];</td>
                                    <td class="columna" hidden>["hora"];</td>
                                    <td class="columna" hidden>["salida"];</td>
                                    <td class="columna" hidden>["llegada"];</td>
                                    <td class="columna" hidden>["regreso"];</td>
                                    <td class="columna">["causa"];</td>
                                    <td class="columna" hidden>["direccion"];</td>
                                    <td class="columna" hidden>["ci_pnb"];</td>
                                    <td class="columna" hidden>["ci_gnb"];</td>
                                    <td class="columna" hidden>["ci_intt"];</td>
                                    <td class="columna" hidden>["ci_invity"];</td>
                                    <td class="columna" hidden>["ci_pc"];</td>
                                    <td class="columna" hidden>["ci_otro"];</td>
                                    <td class="columna"></td>
                                    <td class="columna">></td>
                                    <td class="columna"></td>
                                    <td class="columna"></td>
                                    <td class="columna" hidden>["acta"];</td>
                                    <td class="columna" hidden>["observaciones"];</td> -->
                                    <!-- <td>
                                        ...
                                        <div><a name='eliminar' id='eliminar'
                                                    href='../controlador/ctl_servicio.php?txtID=[id];'
                                                    class="btn icon btn-danger"><i class="bi bi-x"></i></a></div>
                                        </div>
                                    </td>
                                    <td>
                                    <a href="../controlador/ctl_servicio.php?txtIDreporte=['id'];" class="btn icon btn-danger"><i class="bi bi-file-earmark-pdf-fill"></i></a>
                                    </td>
                                </tr> -->
