...
<div class="col-md-6 col-12 m-auto">
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                <form class="form form-vertical" onsubmit="return validarRecursoInoperativo()">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="form-control" placeholder="Ingrese la Cantidad Inoperativa del Recurso" id="nombre_recurso">
