       ...
       Nuevo
        ...
        <div class="modal fade text-left" id="inlineForm1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
            ...
            <!-- Contenido del Modal:--------------------------->
                    ...
                    <form action="#" style="text-align: left;" onsubmit="return validarCargo()">
                        ...
                        <div class="col-12">
                              <div class="form-group has-icon-left">
                                  ...
                                  <div class="position-relative">
                                      <input type="text" class="form-control" placeholder="Coloque el nombre del cargo del bombero" id="cargo">
