...
<button type="button" class="btn icon btn-success" data-bs-toggle="modal" data-bs-target="#inlineForm">
    Registrar Auxilio Medico de Emergencia
</button>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content" id="modal" style="overflow-y: scroll;">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel33">Registrar Auxilio Medico de Emergencia</h4>
                        ...
                        <div class="form-group has-icon-left">
                           ...
                           <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <label class="form-check-label" for="maletin_si">SI</label>
                                        <input type="radio" class="form-check-input" name="recurso[]" value="SI" id="maletin_si">

                                        <label class="form-check-label ms-3" for="maletin_no">NO</label>
                                        <input type="radio" class="form-check-input" name="maletin" value="NO" id="maletin_no">
                                    </div>
                                </div>
                                <div class="form-group has-icon-left" id="cantidad_container" style="display: none;">
                                    <div class="position-relative">
