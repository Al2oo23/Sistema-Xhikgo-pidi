        ...
        <div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
            ...
            <!-- Header del Modal: ----------------------------->
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel33">Modificar Tipo de Incendio </h4>
            ...
            <!-- Contenido del Modal:--------------------------->
                    ...
                    <form action="../controlador/ctl_Tincendio.php" method="POST" style="text-align: left;" onsubmit="return validarTipoIncendioM()">
                        ...
                        <input type="hidden" id="id" name="id">
                            ...
                            <div class="form-group">
                                <input type="text" value="" name="incendio" id="tipo_incendioM" class="form-control" >
                            </div>
                        </div>
