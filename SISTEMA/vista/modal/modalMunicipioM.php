    ...
    <button type="button" class="btn icon btn-primary" data-bs-toggle="modal" data-bs-target="#inlineForm">
        ...
        <div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
            ...
            <!-- Contenido del Modal:--------------------------->
                    ...
                    <form action="../controlador/ctl_municipio.php" method="POST" style="text-align: left;">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input type="text" value="" id="municipioM" name="nombre" class="form-control" >
                            </div>
                            <label>Codigo Postal:</label>
                            <div class="form-group">
                                <input type="text" value="" id="codigoM" name="codigo" class="form-control" >
                            </div>
