        ...
        <div class="modal fade text-left" id="inlineForm1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
            ...
            <!-- Header del Modal: ----------------------------->
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel33">Modificar Incidente de Incendio de Vegetacion</h4>
            ...
            <!-- Contenido del Modal:--------------------------->
                    ...
                    <form action="../controlador/ctl_vegetacion.php" method="POST" style="text-align: left;">
