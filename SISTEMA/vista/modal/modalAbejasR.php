                        ...
                        <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input type="date" id="parte_diaria" name="fecha" class="form-control" placeholder="Parte Diaria">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="form-control" name="hora_salida" id="Hsalida" placeholder="Hora de Salida">
                                        <div class="form-control-icon">
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="form-control" name="hora_llegada" id="Hllegada" placeholder="Hora de Llegada">
                                        <div class="form-control-icon">
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" class="form-control" id="Hregreso" placeholder="Hora de Regreso">
                                        <div class="form-control-icon">
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" id="lugar" name="lugar" class="form-control" placeholder="Lugar del Incidente">
                                        <div class="form-control-icon">
