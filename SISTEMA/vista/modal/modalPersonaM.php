    ...
    <button type="button" class="btn icon btn-primary" data-bs-toggle="modal" data-bs-target="#inlineForm">
        ...
        <div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
            ...
            <!-- Contenido del Modal:--------------------------->
                    ...
                    <form action="../controlador/ctl_persona.php" method="POST" style="text-align: left;">
                        ...
                        <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <select name="genero" class="form-select" id="sexoM">
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    ...
                                    <div class="position-relative">
                                        <select name="tipo_persona" class="form-select" id="tpersonaM">
