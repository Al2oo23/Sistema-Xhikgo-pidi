       ...
       Nuevo
        ...
        <div class="modal fade text-left" id="inlineForm1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
            ...
            <!-- Contenido del Modal:--------------------------->
                    ...
                    <form action="#" style="text-align: left;" onsubmit="return validarMunicipio()">
                        <div class="modal-body">
                                <div class="col-12"> 
                                    <div class="form-group has-icon-left">
                                                <label>Municipio:</label>
                                             <div class="position-relative">                                                
                                                 <input type="text" id="nombre_municipio" class="form-control" placeholder="Nombre del Municipio" id="first-name-icon">
