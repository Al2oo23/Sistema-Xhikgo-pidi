<?php
$nombrePagina = "Bitacora";
require ('../header.php');
include ('../modelo/conexion.php');

// Obtener resultados iniciales
$sentencia = $conexion->prepare("SELECT * FROM bitacora");
$sentencia->execute();
                        ...
                        <tbody id="resultados">
                            <?php foreach ($resultado as $bitacora): ?>
                                <tr class="fila">
                                    ...
                                    <td class="columnas"><?= $bitacora['usuario']; ?></td>
                                    <td class="columnas"><?= $bitacora['accion']; ?></td>
                                    <td class="columnas"><?= $bitacora['fecha']; ?></td>
