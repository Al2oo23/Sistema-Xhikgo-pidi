...
// Consulta para obtener datos de la tabla abejas
$sqlAbejas = "SELECT * FROM abejas WHERE id = :id";
$stmtAbejas = $conexion->prepare($sqlAbejas);
$stmtAbejas->bindParam(":id", $IDreporte, PDO::PARAM_INT);
$stmtAbejas->execute();
$reporte = $stmtAbejas->fetch(PDO::FETCH_ASSOC);
$acta = $reporte['acta'];
...
// Construir el HTML del reporte de Abejas
?>
<!DOCTYPE html>
<!DOCTYPE html>
<html lang="es">
...
<body>
    <div class="container">
        ...
        <table>
            <tr>
                <td style="padding:0;">
                    <h2 align="center">REPORTE DE EXTERMINACIÓN DE ABEJAS</h2>
                </td>
            </tr>
        </table>
