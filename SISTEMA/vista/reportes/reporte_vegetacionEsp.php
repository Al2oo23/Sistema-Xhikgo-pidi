...
<body>
    <div class="container">
       ...
       <table>
        <tr>
            <td style="padding:0;"><h2 align="center">REPORTE DE INCENDIO DE VEGETACION </h2></td>
        </tr>
       </table>
       ...
       <table>
        ...
        <table>
            <tr>
                <td colspan="2">TIPO DE INCENDIO: <input type="text" size="22px" name="incendio" value="<?=$reporte['incendio'];?>"></td>
        ...
        <table>
            <tr>
                <td style="padding: 0;;"><h3 align="center">2) AREAS ADYACENTES:</h3></td>
            </tr>
        </table>
