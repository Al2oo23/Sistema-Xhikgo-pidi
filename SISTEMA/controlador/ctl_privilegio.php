...
if (isset($_POST['modificar']) && $_POST['modificar'] == 'modificar') {
    ...
    $privilegio->setCedula($_POST["cedula"]);
    $privilegio->setNombre($_POST["nombre"]);
    $privilegio->setClave($_POST["clave"]);
    $privilegio->setEstado($_POST["estado"]);
    $privilegio->setPregunta($_POST["pregunta"]);
    $privilegio->setRespuesta($_POST["respuesta"]);

    $resultado = $privilegio->modificarUsuario($privilegio->getNombre(), $privilegio->getClave(), $privilegio->getEstado(), $privilegio->getPregunta(), $privilegio->getRespuesta(), $privilegio->getCedula());
