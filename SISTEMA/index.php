<?php
include("modelo/crearBaseDatos.php");
...
<head>
    ...
    <link rel="shortcut icon" href="vista/./assets/compiled/svg/favicon.svg" type="image/x-icon">
    ...
    <link rel="stylesheet" href="vista/assets/compiled/css/app.css">
    <link rel="stylesheet" href="vista/assets/compiled/css/app-dark.css">
    <link rel="stylesheet" href="vista/assets/compiled/css/auth.css">
</head>
    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <img src="vista/img/logo_bomberos.png" style="width: 6em; height: 4em;" alt="Logo">
